 ...
 * Use the [NotificationResidentFragment.newInstance] factory method to
...
class NotificationResidentFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotificationResidentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NotificationResidentFragment().apply {
